...
public class NoiseGenerator2
{
    ...
    public void generate(double ad, double d, double d1,
            double d2, double d3, double d4)
    {
        int k = 0;
            double d5 = d * d2 + field_4292_a;
            double d6 = d1 * d3 + field_4291_b;
    ...
    public void func_4157_a(double ad[], double d, double d1,
            double d2, double d3, double d4)
    {
        int k = 0;
            double d5 = d * d2 + field_4292_a;
    ...
    private static volatile int field_4296_d[][] = {
        {
            1, 1, 0
        }, {
            -1, 1, 0
